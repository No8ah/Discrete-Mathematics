...
2. 定理7-2(  $n-m+r=2$  )
	...
	- **其中**
		1. $|V(G)|=n$
		2. $|E(G)|=m$
		3. $G有r个\textcolor{pink}{\underline{\textbf{面}}}$
		4. $G是\textcolor{orange}{\underline{\textbf{连通}}}的\textcolor{pink}{\underline{\textbf{平面图}}}$
1. 定理7-3(  $n-m+r=k+1$  )
	...
	- **其中**
		...
		2. $|E(G)|=m$
		3. $G有r个\textcolor{pink}{\underline{\textbf{面}}}$
		4. $G是具有k个\textcolor{orange}{\underline{\textbf{连通分支}}}的\textcolor{pink}{\underline{\textbf{平面图}}}\quad k  \geqslant2$
1. 定理7-4(  $2个条件 \quad \Rightarrow \quad m  \leqslant \frac{l}{l-2}(n-2)$  )
	...
	- **2个条件**
		1. $G是\textcolor{orange}{\underline{\textbf{连通}}}的\textcolor{pink}{\underline{\textbf{平面图}}}$
		2. $\deg(R_{i})  \geqslant l  \geqslant 3$
	- **推论**
	...
	- **小推论**(  $\textcolor{red}{\underline{\textbf{逆否命题}}}$  )
		- **1个条件**
			1. $m > \frac{l}{l-2}(n-2) \quad \forall \ l  \geqslant3$
		- **1个结论**
			1. $G \textcolor{red}{\underline{\textbf{不是}}}\textcolor{orange}{\underline{\textbf{连通}}}的\textcolor{orange}{\underline{\textbf{平面图}}}$
1. 定理7-5(  $2个条件 \quad \Rightarrow \quad m  \leqslant \frac{l}{l-2}(n-k-1)$  )
	- $\textcolor{red}{\underline{\textbf{Euler}}}公式的\textcolor{orange}{\underline{\textbf{变换}}}的\textcolor{orange}{\underline{\textbf{推广}}}$
	- **2个条件**
		1. $G是具有k个\textcolor{orange}{\underline{\textbf{连通分支}}}的\textcolor{orange}{\underline{\textbf{平面图}}}\quad k  \geqslant2$
		2. $\deg(R_{i})  \geqslant l  \geqslant 3$
1. 定理7-6(  $1个条件 \quad \Rightarrow \quad m  \leqslant 3n-6$  )
	- **1个条件**
...
1. 平面图的判定
	1. 插入/消去2度顶点
		...
		2. 定义(  消去2度顶点  )
	2. 图之间的同胚
		1. 定义(  $G_{1}$与$G_{2}$$\textcolor{orange}{\underline{\textbf{同胚}}}$  )
			- **2个条件**
				1. $G_{1}\cong G_{2}$
				2. $G_{1}^{'} \cong G_{2}^{'} \quad \forall \ \textcolor{orange}{\underline{\textbf{插入}}}/\textcolor{orange}{\underline{\textbf{消去}}}\textcolor{pink}{\underline{\textbf{2度顶点}}}$
1.  定理7-7($G是\textcolor{orange}{\underline{\textbf{平面图}}}\quad \Leftrightarrow \quad G中\textcolor{orange}{\underline{\textbf{不含}}}与K_{5}  \ \ 或 \ \ K_{3,3} \textcolor{orange}{\underline{\textbf{同胚}}}的\textcolor{pink}{\underline{\textbf{子图}}}$)
