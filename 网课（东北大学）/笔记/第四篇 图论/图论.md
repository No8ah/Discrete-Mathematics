...
1. 定理5-1(  $G是\textcolor{orange}{\underline{\textbf{Hamilton图}}} \quad \Rightarrow \quad 1个结论$  ) #离散数学/重要定理 
	...
	- **推论**
		...
		- **1个结论**
			1. $\forall \ V_{1} \subset V \ \ 且\ \ V_{1} \neq \phi \quad S.t. \quad  p(G-V_{1})  \leqslant |V_{1}|+1$
	 - **小推论**(  $\textcolor{red}{\underline{\textbf{逆否命题}}}$  ) #离散数学/重要小推论 
		...
		- **解释**
			- $只要:\qquad 找到\textcolor{orange}{\underline{\textbf{点割集}}}$
			- $S.t.:\qquad 删去\textcolor{pink}{\underline{\textbf{点割集}}}的|\textcolor{orange}{\underline{\textbf{连通分支}}}|>|\textcolor{orange}{\underline{\textbf{点割集}}}|$
			- $那么:\qquad G \textcolor{red}{\underline{\textbf{不是}}}\textcolor{orange}{\underline{\textbf{Hamilton图}}}$
		 - **1个条件**
			 1. $\exists \ V_{0} \subset V \ \ 且\ \ V_{0} \neq \phi  \quad S.t. \quad  p(G-V_{0}) >|V_{0}|$
		 - **1个结论**
...
2. 定理5-2(  $1个条件 \quad \Rightarrow \quad G中\textcolor{orange}{\underline{\textbf{存在}}}\textcolor{pink}{\underline{\textbf{Hamilton通路}}} \quad \leftrightarrow \quad G是\textcolor{pink}{\underline{\textbf{半Hamilton图}}}$  ) #离散数学/重要定理 
	...
	- **解释**
		- $只要:\qquad 找到\delta(G)$
		- $并且:\qquad 验证2 \delta(G)  \geqslant |V(G)|-1$
		- $那么:\qquad G \textcolor{red}{\underline{\textbf{是}}}\textcolor{orange}{\underline{\textbf{半Hamilton图}}}$
	- **1个先决条件**
	...
	- **小推论**(  $\textcolor{red}{\underline{\textbf{逆否命题}}}$  )
		- **1个先决条件**
			1. $G是n阶 \textcolor{pink}{\underline{\textbf{无向简单图}}}$
		- **1个条件**
			1. $G \textcolor{red}{\underline{\textbf{不是}}}\textcolor{orange}{\underline{\textbf{半Hamilton图}}}$
		- **1个结论**
			1. $\exists \ 两个\ \textcolor{orange}{\underline{\textbf{不相邻}}}的结点v_{i} \ , \ v_{j} \in V(G) \quad S.t. \quad d(v_{i})+d(v_{j}) <n$
...
1. 无向树的定义
	1. 定义(  [[无向树]]  )
		- $\textcolor{orange}{\underline{\textbf{连通}}}\ \textcolor{orange}{\underline{\textbf{无回路}}}的 \textcolor{pink}{\underline{\textbf{无向图}}}$
	2. 定义(  [[森林]]  )
		- $\textcolor{orange}{\underline{\textbf{连通分支}}}\ \textcolor{red}{\underline{\textbf{都是}}}\textcolor{orange}{\underline{\textbf{树}}}$
	3. 定义(  [[叶子节点]]  )
		- $d(v)=1$
	4. 定义(  [[分支节点]]  )
		- $d(v)  \geqslant2$
1. 定理9-1(  $G是\textcolor{orange}{\underline{\textbf{树}}}\quad \Leftrightarrow \quad 5个等价命题$  )
	...
	- **5个等价命题**
		...
		5. $G中\textcolor{orange}{\underline{\textbf{无回路}}}\ \ 且\ \ 1个条件$
			- **1个条件**
...
2. 定理9-2(  $1个条件 \quad \Rightarrow \quad 1个结论$  )
