...
4. 定理7-5(  $2个条件 \quad \Rightarrow \quad m  \leqslant \frac{l}{l-2}(n-k-1)$  )
	...
	- **2个条件**
		...
		2. $\deg(R_{i})  \geqslant l  \geqslant 3$
5. 定理7-6(  $1个条件 \quad \Rightarrow \quad m  \leqslant 3n-6$  )
	- **1个条件**
...
7.  定理7-7($G是\textcolor{orange}{\underline{\textbf{平面图}}}\quad \Leftrightarrow \quad G中\textcolor{orange}{\underline{\textbf{不含}}}与K_{5}  \ \ 或 \ \ K_{3,3} \textcolor{orange}{\underline{\textbf{同胚}}}的\textcolor{pink}{\underline{\textbf{子图}}}$)
