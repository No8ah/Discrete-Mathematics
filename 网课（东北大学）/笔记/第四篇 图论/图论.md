...
4. 定理7-6(  $1个条件 \quad \Rightarrow \quad m  \leqslant 3n-6$  )
	...
	- **小推论** #离散数学/重要小推论 
		- $判断G \textcolor{red}{\underline{\textbf{不是}}}\textcolor{orange}{\underline{\textbf{平面图}}}的重要小推论$
		- $\textcolor{pink}{\underline{\textbf{定理7-6}}}的\textcolor{red}{\underline{\textbf{逆否命题}}}$
		- **1个条件**
			1. $m > 3n-6$
		- **1个结论**
...
2.  定理7-7(  $G是\textcolor{orange}{\underline{\textbf{平面图}}}\quad \Leftrightarrow \quad G中\textcolor{orange}{\underline{\textbf{不含}}}与K_{5}  \ \ 或 \ \ K_{3,3} \textcolor{orange}{\underline{\textbf{同胚}}}的\textcolor{pink}{\underline{\textbf{子图}}}$  )
